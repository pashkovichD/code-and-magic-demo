...
/*
  ...
  Имя генерируется из массивов имён и фамилий: нужно случайным образом выбрать
  из массива имён имя, а из массива фамилий фамилию и сложить их.
    Имена:
      Иван
      Хуан Себастьян
      Мария
...
// console.log('getRandomPositiveInteger: ' + getRandomPositiveInteger(0,10));
